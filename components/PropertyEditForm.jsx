            ...
            <div className="mb-4">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-2">
                    ...
                    <div>
                        ...
                        />
                        <label htmlFor="high_speed_internet">High-Speed Internet</label>
                    </div>
                    <div>
                        <input
                            type="checkbox"
                    ...
                    <div>
                        ...
                        />
                        <label htmlFor="beach-access">Beach Access</label>
                    </div>
                    <div>
                        <input
                            type="checkbox"
                            ...
                            name="amenities"
                            value="Hiking Trail Access"
                            className="mr-2"
                            defaultChecked={property.amenities.includes('Hiking Trail Access')}
                        />
                        <label htmlFor="hiking_trail_access">Hiking Trail Access</label>
                    </div>
                    <div>
                        <input
                            type="checkbox"
                    ...
                    <div>
                        ...
                        />
                        <label htmlFor="mountain_view">Mountain View</label>
                    </div>
                </div>
            </div>
